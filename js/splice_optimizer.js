...
function initSpliceOptimizer() {
  ...
  const totalLevelsLabel = createNodeFromHTML(
    '<label for="TotalLevels">Second Multiplier: </label>'
  );

  totalLevelsInput.addEventListener("change", () => {
  ...
  totalLevels.appendChild(totalLevelsLabel);
  totalLevels.appendChild(totalLevelsInput);
